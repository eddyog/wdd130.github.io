...
request.onload = function () {
  ...
  templeQuetzaltenango(templeData);
}
...
function templeQuetzaltenango(jsonObj) {
  ...
  for (i = 0; i < temples.length; i++) {
    var name = temples[i].name;
    if (name == "Quetzaltenango Guatemala") {
...
let apiURLstring = 'https://api.openweathermap.org/data/2.5/weather?id=3590978&units=imperial&appid=5b80935c4ea5e0ea9c17310ade26c1ed';
